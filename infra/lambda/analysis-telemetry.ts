...
const PROVIDER_PREFLIGHT_FAILURE_REASONS = new Set(['ACCESS_DENIED', 'VALIDATION', 'THROTTLED', 'SERVICE_UNAVAILABLE', 'CREDENTIALS', 'NETWORK', 'CLIENT_CONFIGURATION', 'SDK_DESERIALIZATION', 'SDK_DATE_DESERIALIZATION', 'CLIENT_TYPE_ERROR', 'CLIENT_ERROR', 'NAME_MISSING', 'SDK_METADATA_UNKNOWN', 'INVALID_RESPONSE', 'MODE_NOT_ALLOWED', 'UNKNOWN']);
