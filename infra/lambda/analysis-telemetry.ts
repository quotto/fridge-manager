...
const PROVIDER_PREFLIGHT_FAILURE_REASONS = new Set(['ACCESS_DENIED', 'VALIDATION', 'THROTTLED', 'SERVICE_UNAVAILABLE', 'CREDENTIALS', 'NETWORK', 'CLIENT_CONFIGURATION', 'SDK_DESERIALIZATION', 'CLIENT_RUNTIME', 'NAME_MISSING', 'SDK_METADATA_UNKNOWN', 'INVALID_RESPONSE', 'MODE_NOT_ALLOWED', 'UNKNOWN']);
